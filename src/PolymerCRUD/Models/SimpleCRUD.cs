...
namespace PolymerCRUD.Models
{
    ...
    public static partial class SimpleCRUD
    {
        ...
        public static T Get<T>(this NpgsqlConnection connection, object id, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static IEnumerable<T> GetList<T>(this NpgsqlConnection connection, object whereConditions, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var idProps = GetIdProperties(currenttype).ToList();
            if (!idProps.Any())
        ...
        public static IEnumerable<T> GetList<T>(this NpgsqlConnection connection, string conditions, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var idProps = GetIdProperties(currenttype).ToList();
            if (!idProps.Any())
        ...
        public static IEnumerable<T> GetList<T>(this NpgsqlConnection connection)
        {
        ...
        public static IEnumerable<T> GetListPaged<T>(this NpgsqlConnection connection, int pageNumber, int rowsPerPage, string conditions, string orderby, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static int? Insert(this NpgsqlConnection connection, object entityToInsert, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static TKey Insert<TKey>(this NpgsqlConnection connection, object entityToInsert, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static int Update(this NpgsqlConnection connection, object entityToUpdate, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static int Delete<T>(this NpgsqlConnection connection, T entityToDelete, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records effected</returns>
        public static int Delete<T>(this NpgsqlConnection connection, object id, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var idProps = GetIdProperties(currenttype).ToList();
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records effected</returns>
        public static int DeleteList<T>(this NpgsqlConnection connection, object whereConditions, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records effected</returns>
        public static int DeleteList<T>(this NpgsqlConnection connection, string conditions, NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static int RecordCount<T>(this NpgsqlConnection connection, string conditions = "", NpgsqlTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
            var sb = new StringBuilder();
        ...
        private static string GetTableName(Type type)
        {
            ...
            var tableattr = type.GetTypeInfo().GetCustomAttributes(true).SingleOrDefault(attr => attr.GetType().Name == "TableAttribute") as dynamic;
            if (tableattr != null)
            {
